...
function App() {
  ...
  const personalDetails = {
    name: "Niyath Nair",
    location: "India",
    email: "nair.4@iitj.ac.in",
    brand:
      "My diverse skill set combining technical proficiency with creative problem-solving, complemented by a background in psychology, enables me to analyze data with a keen focus on user-centric perspectives, delivering impactful insights for digital products.",
  };
